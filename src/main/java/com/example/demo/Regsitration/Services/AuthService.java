package com.example.demo.Regsitration.Services;


import com.example.demo.Regsitration.Controllers.Responses.AuthResponse;
import com.example.demo.Regsitration.Controllers.Responses.BadResponse;
...
public class AuthService {
    ...
    public Response userRegistration(@NonNull RegisterRequest registerRequest) {

        if(userRepo.countByEmail(registerRequest.getEmail()) == 1){
    ...
    @Transactional
    public AuthResponse userAuthentication(@NonNull AuthRequest authenticationRequest) {
